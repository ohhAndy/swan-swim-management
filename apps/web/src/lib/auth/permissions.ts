...
export function canViewStudents(role: StaffRole): boolean {
...
export function hasPermission(
  role: StaffRole,
  action: 'viewStudents' | 'editStudents' | 'createStudents' | 'deleteStudents' | 
         'enrollStudents' | 'transferEnrollments' | 'scheduleMakeups' | 
         'markAttendance' | 'manageTerms' | 'viewInvoices' | 'manageInvoices' | 
         'manageStaff'
): boolean {
  const permissionMap = {
