// lib/api/students-client.ts
import { createClient } from '@/lib/supabase/client'
import { CreateStudentInput } from '../zod/student'

export type StudentLite = { id: string; firstName: string; lastName: string; shortCode: string | null, level: string | null, birthdate: string | null };
