...
import { createStudentSchema, updateStudentSchema, searchStudentsSchema, SearchStudentsDto, CreateStudentDto, UpdateStudentDto } from "./dto/schemas.dto";
...
export class StudentsController {
    ...
    @Get()
    async searchOrList(@Query(new ZodValidationPipe(searchStudentsSchema)) query: SearchStudentsDto) {
