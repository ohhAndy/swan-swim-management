...
export class ClassInstructorsController {
  ...
  async assignInstructor(
    @Body() body: { classOfferingId: string; staffUserId: string },
  ...
  async getActiveInstructors(@Param('classOfferingId') classOfferingId: string) {
    return this.service.getActiveInstructorsForClass(classOfferingId);
  }

  @Get('class/:classOfferingId/history')
  async getInstructorHistory(@Param('classOfferingId') classOfferingId: string) {
    return this.service.getInstructorHistory(classOfferingId);
  }

  @Get('instructor/:staffUserId')
  async getClassesForInstructor(
