...
import { createGuardianSchema, updateGuardianSchema, searchGuardianSchema, SearchGuardianDto, CreateGuardianDto, UpdateGuardianDto } from "./dto/schemas.dto";
...
export class GuardiansController {
    ...
    @Get()
    async searchOrList(@Query(new ZodValidationPipe(searchGuardianSchema)) query: SearchGuardianDto) {
