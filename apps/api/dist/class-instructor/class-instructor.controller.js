...
const class_instructor_service_1 = require("./class-instructor.service");
...
let ClassInstructorsController = class ClassInstructorsController {
    ...
    async assignInstructor(body, staffUser) {
        ...
        return this.service.assignInstructor(body.classOfferingId, body.staffUserId, staffUser.id);
    }
    async removeInstructor(id, staffUser) {
        return this.service.removeInstructor(id, staffUser.id);
    }
...
__decorate([
    ...
    __param(1, (0, current_user_decorator_1.CurrentStaffUser)()),
...
exports.ClassInstructorsController = ClassInstructorsController = __decorate([
    ...
    __metadata("design:paramtypes", [class_instructor_service_1.ClassInstructorsService])
